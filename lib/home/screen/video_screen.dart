...
import 'package:gutrgoopro/ad/screen/ad_overly.dart';
...
void initState() {
 ...
 WidgetsBinding.instance.addPostFrameCallback((_) {
  ...
  if (widget.vastTagUrl != null && widget.vastTagUrl!.isNotEmpty) {
    ...
    try { _controller.setVolume(0); } catch (_) {}
    ...
    if (event.betterPlayerEventType == BetterPlayerEventType.finished) {
      try {
        ...
        if (mounted && !_isDisposed) {
          ...
          _hideTimer?.cancel(); // Keep controls visible at end
        }
      } catch (_) {}
      return;
    }
...
//   void didPopNext() {
//     super.didPopNext();
//     // Resume if needed — optional, remove if you don't want auto-resume
//     if (!_controllerDisposed && !_isDisposed) {
//       setState(() {
//         _showControls = true;
//       });
...
//   // ✅ Safely dispose the controller only once
//   void _disposeController() {
//     if (_controllerDisposed) return;
//     _controllerDisposed = true;
...
//   // ✅ Navigate away from VideoScreen using Get.to — pause before navigating
//   void _navigateToDetail({
//     required String videoTrailer,
//     required String videoMovies,
//     required String imageUrl,
...
//     required String dis,
//   }) async {
//     // ✅ Pause BEFORE navigating so video stops immediately
//     if (!_controllerDisposed) {
//       try {
//         _controller.pause();
//       } catch (_) {}
...
//   @override
//   void deactivate() {
//     // ✅ Always pause when screen is deactivated (covered or popped)
//     if (!_controllerDisposed && !_isInFullscreen) {
//       try {
//         _controller.pause();
//       } catch (e) {
...
//                         bottom: 0,
//                         child:
//                             Center(child: _sideIndicator(Icons.volume_up, volume)),
//                       ),
//                   ],
//                 ),
//               ),
...
// // ─────────────────────────────────────────────────────────────────────────────
// // STEP 2: Register RouteObserver in your app's MaterialApp
// // Add this to your main.dart or wherever you define MaterialApp:
// //
// // MaterialApp(
// //   navigatorObservers: [VideoScreen.routeObserver],
// //   ...
// // )
// // ─────────────────────────────────────────────────────────────────────────────

// // ─────────────────────────────────────────────────────────────────────────────
// // FULLSCREEN PAGE (unchanged from original — included for completeness)
// // ─────────────────────────────────────────────────────────────────────────────
...
//                     double delta = details.primaryDelta! / 300;
//                     _volume =
//                         (_volume - delta).clamp(0.0, 1.0).toDouble();
//                     VolumeController().setVolume(_volume);
//                     if (!_isDisposed) setState(() => showVolumeUI = true);
//                     volumeTimer?.cancel();
//                     volumeTimer =
...
//                 child: Center(
//                     child:
//                         _sideIndicator(Icons.brightness_6, _brightness)),
//               ),
