...
//     errorMessage.value = '';
//     print('📤 [Controller] verifyOtp() → phone: ${phoneNumber.value} | otp: $otp');
//       final phoneWithCode = '+91${phoneNumber.value}';
//   print('📤 Sending OTP verify for phone: $phoneWithCode, otp: $otp');

//   final result = await _otpService.verifyOtp(phoneWithCode, otp.trim());
//     isVerifying.value = false;
